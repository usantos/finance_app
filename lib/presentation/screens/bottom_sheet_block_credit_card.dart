  ...
  Widget build(BuildContext context) {
    return Column(
      children: [
        ...
        Row(
          children: [
            ...
            IconButton(
              ...
              icon: const Icon(Icons.chevron_right, color: AppColors.black, size: 25),
            ),
          ],
        ),
        ...
        Row(
          children: [
            const Text("Bloqueio Preventivo", style: TextStyle(fontSize: 18, color: AppColors.black)),
            const Spacer(),
            IconButton(
              onPressed: () {
                _openTemplate(
                  title: 'Bloqueio Preventivo',
                  typeTitle: 'BLOCKED_PRV',
                  buttonText: 'Confirmar',
                  method: 'Block',
                  body: Center(
                    heightFactor: 1.6,
                    child: Card(
                      ...
                      child: Padding(
                        padding: const EdgeInsets.all(24),
                        child: Text(
                          'O bloqueio preventivo é uma medida de segurança. \nUse esta opção se suspeitar de uso indevido, perda temporária ou qualquer atividade fora do comum.\n\nVocê poderá revisar e desbloquear após verificar sua conta.',
                          style: TextStyle(fontSize: 18, color: AppColors.black),
                        ),
                      ),
                    ),
